...
class Home extends Component {
  render() {
    ...
    //               It's hard knowing everything you know. Effortlessly surface
    ...
    //             Tangle is a notebook that treats your reference materials like
    //             building blocks. Tangle helps assemble your blocks as you
    //             construct your next big idea. And it does it all without you
    ...
    //             <div className={`f3 dark-gray fw4 pb4`}>Take better notes.</div>
    //             <div className={`f4 mid-gray fw2`}>
    //               Tangle's building blocks promote shorter, more concise
    //               writing. Each note you take helps to build your knowledge.
    //             </div>
    //           </div>
    //         </div>
    //         <div className={`dt-row dtc-l v-mid w-100 w-50-l`}>
    ...
    //               Tangle fits your building blocks together for you like a
    //               puzzle. No more wasting time with folder organization.
    //             </div>
    //           </div>
    //         </div>
    //       </div>
